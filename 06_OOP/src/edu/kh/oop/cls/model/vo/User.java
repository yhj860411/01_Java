...
public class User {
	...
	// 매개변수 생성자 자동완성
	// alt + s -> Generate Constructor using Fields... -> generate 클릭
...
//		this.userPw = userPw;
	...
	// 매개변수의 갯수가 같은 것은 있으나 타입이 다름 -> 오버로딩 성립
	
	public User(String userId, int userAge) {}
	// 매개변수의 개수와 동일한 것이 있으나, 하나의 타입이 다름 -> 오버로딩 성립
	
	public User(int userAge, String userId) {}
	// 매개변수의 개수, 타입은 같지만 순서가 다름 -> 오버로딩 성립
	
	// public User(int age, String name) {}
	// 매개변수의 개수, 타입, 순서가 모두 같아서 불가 -> 변수명은 신경쓰지 않는다.
