...
public class PolyService {
	...
	public void ex3() {
		...
		// 주의!
		// "." 연산자는 (Tesla) 형변화 연산자보다 우선순위 높음!
		// 그래서 형변환 부분을 ()로 묶어주고 나서 .연산을 진행해야
	...
	public void ex5() {
		...
		// Car.toString() 메서드와 연결 -> 정적바인딩
		// 실행해보면 자식(Spark)의 toString() 호출되는 것을 확인
		// -> 컴파일 시에는 부모와 바인딩 == 정적바인딩
		// -> 실행 시에는 Spark에 오버라이딩된 toString()이 우선시 되어
		// Spark 메서드와 바인딩 == 동적바인딩
	}
